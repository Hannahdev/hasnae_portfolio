    ...
    return (
        <div id="top" className="w-11/12 max-w-3xl text-center mx-auto min-h-screen flex flex-col items-center justify-center gap-4 pt-28">
            ...
            <div className="flex items-center gap-4 mt-6">
                ...
                <a href="https://www.linkedin.com/in/hasnae-el-mir-01b7ab1b9" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/60 dark:bg-white/[0.06] backdrop-blur-sm border border-gray-200/60 dark:border-white/[0.08] flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:border-gray-300 dark:hover:border-white/20 hover:shadow-md hover:scale-110 transition-all duration-300">
