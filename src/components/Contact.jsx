...
export default function Contact() {
    ...
    return (
        <div id="contact" className="w-full px-[12%] py-10 scroll-mt-20 bg-[url('./assets/footer-bg-color.png')] bg-no-repeat bg-[length:90%_auto] bg-center dark:bg-none">
            ...
            <form action="https://formsubmit.co/elmirhasnae55@gmail.com" method="POST" className="max-w-2xl mx-auto">
                <input type="hidden" name="_subject" value="New Form Submission - Portfolio" />
